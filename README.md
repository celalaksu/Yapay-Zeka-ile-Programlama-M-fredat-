...
[![GitHub stars](https://img.shields.io/github/stars/celalaksu/Yapay-Zeka-ile-Programlama-M-fredat-?style=social)](https://github.com/celalaksu/Yapay-Zeka-ile-Programlama-M-fredat-)
[![GitHub forks](https://img.shields.io/github/forks/celalaksu/Yapay-Zeka-ile-Programlama-M-fredat-?style=social)](https://github.com/celalaksu/Yapay-Zeka-ile-Programlama-M-fredat-/fork)
...
```mermaid
graph LR
A[Teoriyi Oku] --> B[Pratik Yap]
B --> C[Küçük Proje Oluştur]
C --> D[Kendini Test Et]
D --> E[Sonraki Seviye]
```
